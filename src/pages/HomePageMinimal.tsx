      ...
      <main className="flex-1 flex items-center justify-center px-6 pt-16">
        <div className="mx-auto max-w-4xl text-center animate-fadeIn">
          ...
          <div className="mb-8 flex justify-center">
            <div className="animate-float">
              <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-primary/10">
                <div className="h-5 w-5 rounded-full bg-red-500 shadow-[0_0_15px_rgba(239,68,68,0.5)]"></div>
              </div>
            </div>
          </div>
          ...
          <p className="mb-12 text-xl text-muted-foreground lg:text-2xl">
            ...
            <br />
            <span className="text-base">Debug. Monitor. Discover.</span>
          </p>

          {/* Products Grid */}
          <div className="mb-12 grid gap-6 md:grid-cols-3 text-left">
            {/* Platform */}
            <div className="group rounded-xl border border-border bg-card p-8 transition hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10">
              ...
              <h3 className="mb-3 text-xl font-semibold">Platform</h3>
            ...
            <div className="group rounded-xl border border-border bg-card p-8 transition hover:border-primary/50 hover:shadow-lg hover:shadow-primary/10">
              ...
              <h3 className="mb-3 text-xl font-semibold">Hub</h3>
              <p className="mb-4 text-sm text-muted-foreground">
